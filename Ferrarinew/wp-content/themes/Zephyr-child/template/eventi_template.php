...
Template Name: News Event Template
...
<?php 
$gruppo_campi = get_field('contenuti_del_post'); 
$immagine = $gruppo_campi['immagine'];
?>

<div class="sma-none" style="height: var(--header-height)"></div>
    ...
    <div class="course-above grid grid--full">
        ...
        <div class="above-content col-100 grid grid--full">
            ...
            <div class="col-35 page-padding course-information grid">
                <div class="col-100">
                    <span class="tag-style"><?php echo $gruppo_campi['typology'];?></span>
